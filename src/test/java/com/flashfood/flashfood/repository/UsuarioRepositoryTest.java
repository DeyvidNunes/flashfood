...
class UsuarioRepositoryTest {
    ...
    void deveSalvarUsuarioEGerarIdComCascadeDeEndereco() {
        ...
        Usuario usuario = new Cliente(null, "Joao Silva", "joao@email.com", "123456", endereco);
    ...
    void deveEncontrarUsuarioPorEmail() {
        Usuario usuario = new Cliente(null, "Maria Souza", "maria@email.com", "123456", null);
    ...
    void deveRetornarTrueQuandoEmailJaCadastrado() {
        Usuario usuario = new Cliente(null, "Pedro Lima", "pedro@email.com", "123456", null);
        usuarioRepository.save(usuario);
