...
class ProdutoRepositoryTest {
    ...
    void deveSalvarProdutoEGerarId() {
        Restaurante restaurante = restauranteRepository.save(new Restaurante(null, "Burguer King's", "Lanches", 5.0, "20-30 min", null, null));
    ...
    void deveListarApenasProdutosAtivosDoRestaurante() {
        Restaurante restaurante = restauranteRepository.save(new Restaurante(null, "Pizzaria Bella", "Pizza", 6.0, "40-50 min", null, null));
    ...
    void naoDeveListarProdutosDeOutroRestaurante() {
        Restaurante restauranteA = restauranteRepository.save(new Restaurante(null, "Restaurante A", "Regional", 5.0, "30 min", null, null));
        Restaurante restauranteB = restauranteRepository.save(new Restaurante(null, "Restaurante B", "Regional", 5.0, "30 min", null, null));
